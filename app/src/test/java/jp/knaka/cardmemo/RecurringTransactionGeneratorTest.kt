...
class RecurringTransactionGeneratorTest {
 ...
 private fun expense(contract:String="2026-07-01",interval:Int=1,end:String?=null,revisions:List<PriceRevision> = emptyList())=RecurringExpense(id=1,amount=1000L,category="固定費",merchant="Netflix",description="動画",paymentDay=10,startMonth="2026-07",contractDate=contract,paymentSourceId="card",intervalMonths=interval,endDate=end,priceRevisions=revisions)
}
